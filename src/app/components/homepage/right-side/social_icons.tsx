  ...
  return (
    <div className="mt-2 flex h-20 w-full items-center justify-center gap-12">
      ...
      <a
        ...
        rel="noopener noreferrer"
      >
        <FaGithub className="size-14 rounded-full text-white transition-all duration-100 ease-in-out hover:border-2 hover:bg-white hover:text-purple-900"></FaGithub>
      </a>
    </div>
  )
}
